...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, nome: @produto.nome, nota_media: @produto.nota_media }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { descricao: @produto.descricao, nome: @produto.nome, nota_media: @produto.nota_media }
    assert_redirected_to produto_path(assigns(:produto))
  end
